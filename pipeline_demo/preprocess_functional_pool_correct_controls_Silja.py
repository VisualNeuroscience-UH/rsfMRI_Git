...
def prepro_func(i):
	try:
		...
		for s in (['session1']):
		    ...
		    func1 = data_path + subj +'/Functional_scans/00003/epi.nii.gz' #choose this for controls
		    func2 = data_path + subj +'/Functional_scans/00004/epi.nii.gz' #choose this for controls
			...
			workflow.connect(erode_CSF_mask, 'out_file', reg_CSF_mask, 'in_file')
