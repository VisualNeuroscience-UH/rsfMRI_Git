...
9. Saves voxel weighs that are used in the model to predict the acticity of a ROI under inquiry as .nii.gz images. Results are reported as images in folder 'coeffmaps1' and '2' in the same folder as SVR results.  
10.  Saves the number and percentage of voxels per ROI after mask inclusion as a .text file.
...
for k in range(0, len(subj_dirs)):
	...
	results_path = '/opt1/MR_data/Silja_Raty/New_rs/results/Unmasked_results/'+subj+'/'
